 ...
 */
class Adaptador_Categorias extends ArrayAdapter {
    private Context context;
    private ArrayList<Categoria> datos;

    public Adaptador_Categorias(Context context, ArrayList datos) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View item = inflater.inflate(R.layout.categorias_view, null);
